    ...
    <div>
     ...
     <img src={aa} alt="Description of " style={{ height: '74%', maxWidth: '74%', }} />
      ...
      {step === "process" ? (
        ...
        <a href="tel:+13236897861">             <div className="call-btn" onClick={handleCall}>             CALL (323) 689-7861           </div>           </a>        <div className="sub-title">We Have Reserved Your Spot</div>
